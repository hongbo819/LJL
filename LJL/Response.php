...
class LJL_Response
{
	...
	*/
    ...
    public function cookie($name, $value = null, $expire = 0, $path = null, $domain = 'cuihongbo.com', $secure = false, $httponly = false)
    {
	...
	{
		if (false && function_exists('ob_gzhandler') && defined("IS_PRODUCTION") && IS_PRODUCTION === true)#生产环境开启
		{
