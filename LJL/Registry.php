...
class LJL_Registry
{
    ...
    */
    public static function get($key)
    {
        if (!self::exists($key)) {
            ...
            //return false;
            throw new LJL_Exception("No entry is registered for key: $key");
        }
    ...
    */
    ...
    {
        if (self::exists($key)) {
            throw new LJL_Exception("An entry is already registered for key: $key");
        }
        LJL_Registry::$_aProps[$key] = $obj;
    }
