...
define('APP_BLOG_NAME', 'laura'); // 配置博客名称
define('BLOG_WEB_NAME', '安之若素'); // 配置博客名称
define('BLOG_SEO_TITTLE', BLOG_WEB_NAME.'-遇见最好的时光，遇见最好的你!'); // 配置title
define('WEIBO_UID', '3078279367'); // 配置微博uid
